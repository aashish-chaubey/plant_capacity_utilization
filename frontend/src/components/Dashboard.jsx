...
export default function Dashboard({
  ...
  const kpis = [
    ...
    { label: "Runtime",            value: formatPercent(Math.round(calculatePercentage(data.summary.total_runtime,      totalAvailableCapacity))), valueLabel: "of Available Time", tone: "green",     detail: formatKpiDuration(data.summary.total_runtime), subDetail: Number(data.summary.total_overrun_minutes || 0) > 0 ? `Overrun: ${formatKpiDuration(data.summary.total_overrun_minutes)}` : "" },
...
const CHAT_CAPACITY_SLICE_COLORS = {
  ...
  "Unplanned Capacity": CAPACITY_SPLIT_COLORS.idle_time,
};
